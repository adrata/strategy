-- TOP Engineers Plus Conservative Data Enrichment Script
-- This script enriches the TOP Engineers Plus workspace using existing schema fields with proper field lengths
-- Workspace ID: 01K5D01YCQJ9TJ7CT4DZDE79T1

-- Update the workspace with TOP Engineers Plus context
UPDATE "workspaces" 
SET 
  "description" = 'TOP Engineers Plus - Communications Engineering firm specializing in critical infrastructure and broadband deployment.',
  "updatedAt" = NOW()

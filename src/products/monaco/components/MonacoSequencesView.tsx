...
export function MonacoSequencesView({}: MonacoSequencesViewProps) {
  ...
  const sequencesLeftPanel = (
    <div className="w-[15.03rem] min-w-[15.03rem] max-w-[15.03rem] bg-[var(--background)] text-[var(--foreground)] border-r border-[var(--border)] flex flex-col pt-0 pr-2 pb-6 pl-2 overflow-y-auto">

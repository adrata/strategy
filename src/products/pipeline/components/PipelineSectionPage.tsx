          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-2xl w-[520px] p-7">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="mb-2">
                  <p className="font-medium text-gray-900">{activeSignal?.contact.name || 'Sarah Mitchell'}</p>
                  <p className="text-sm text-gray-600">{activeSignal?.contact.title || 'IT Director'} at {activeSignal?.contact.company || 'Retail Solutions Inc'}</p>
                </div>

        ...
        {activeTab === 'info' && (
          <div className="p-4">
            <div className="space-y-6">
              {/* Channel Info */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 mb-3">Channel Details</h3>
                <div className="space-y-3">
                  <div>
        ...
        {activeTab === 'ai' && (
          <div className="p-4">
              ...
              {aiActions.map((action) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-start gap-3 p-3 text-left hover:bg-gray-50 rounded-lg transition-colors border border-gray-200"
                  >
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              ...
              <div className="space-y-2">
                <button className="w-full flex items-center gap-2 p-2 text-sm text-gray-600 hover:bg-gray-50 rounded transition-colors">

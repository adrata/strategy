  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-background rounded-lg p-6 w-96 max-w-[90vw]">
        ...
        <div className="mb-4">
          <div className="w-32 h-32 mx-auto bg-loading-bg rounded-xl flex items-center justify-center overflow-hidden border-2 border-border relative">
            {previewUrl ? (
              <div 
          ...
          {previewUrl && (
            <div className="flex justify-center gap-2 mt-2">
              <button
                ...
                className="p-1 rounded-full bg-hover hover:bg-loading-bg transition-colors"
                title="Zoom Out"
              >
                <MagnifyingGlassMinusIcon className="w-4 h-4 text-muted" />
              </button>
              <span className="text-xs text-muted px-2 py-1 bg-hover rounded">
                {Math.round(zoom * 100)}%
              </span>
              <button
                ...
                title="Zoom In"
              >
                <MagnifyingGlassPlusIcon className="w-4 h-4 text-muted" />
              </button>
            </div>
          )}
        </div>
        ...
        <div className="flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 py-2 px-4 border border-border rounded-lg text-sm font-medium text-gray-700 hover:bg-panel-background transition-colors"
          >
            Cancel
          </button>
          <button

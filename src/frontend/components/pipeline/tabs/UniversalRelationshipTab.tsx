...
export function UniversalRelationshipTab({ record, recordType }: UniversalRelationshipTabProps) {
  return (
    <div className="p-6 space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-500 mt-1">Current relationship level</p>
          </div>
          
          <div className="bg-green-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">Client Since</h4>
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">Satisfaction Score</h4>
            <div className="text-2xl font-bold text-purple-600">
              {record?.satisfactionScore ? `${Math.round(record.satisfactionScore)}/10` : '-'}
            </div>
            <p className="text-sm text-gray-500 mt-1">Overall satisfaction</p>
          </div>
        </div>
      </div>
      ...
      {/* Key Contacts */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Key Relationships</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">{record?.accountManager || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Success Manager:</span>
                <span className="font-medium text-gray-900">{record?.successManager || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Executive Sponsor:</span>
                <span className="font-medium text-gray-900">{record?.executiveSponsor || '-'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">{record?.meetingFrequency || 'Monthly'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Communication Style:</span>
                <span className="font-medium text-gray-900">{record?.communicationStyle || 'Professional'}</span>
              </div>
              <div className="flex justify-between">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Relationship Milestones</h3>
      ...
      {/* Trust & Advocacy */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Trust & Advocacy</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Referral Activity</span>
                <span className="font-medium text-gray-900">{record?.referralsProvided || 0} referrals</span>
              </div>
              <div className="flex justify-between items-center">

          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Need Urgency</label>
                  <InlineEditField
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Marketing Qualified</label>
            ...
            {/* Sales Qualification */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Sales Qualification</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Sales Qualified</label>
                  <div className="text-sm text-gray-800 font-medium">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-1">Decision Making Style</label>
                  <InlineEditField
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-200">
                      {record?.interests?.length > 0 ? (
                        ...
                        <p className="text-sm text-gray-500">No interests identified yet</p>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-200">
                      {record?.buyingSignals?.length > 0 ? (
                        ...
                        <p className="text-sm text-gray-500">No buying signals detected yet</p>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-200">
                      {record?.competitorMentions?.length > 0 ? (
                        ...
                        <p className="text-sm text-gray-500">No competitors mentioned yet</p>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-200">
                      {record?.professionalGoals?.length > 0 ? (
                        ...
                        <p className="text-sm text-gray-500">No professional goals identified yet</p>
                      )}
                    </div>
                  </div>
                </div>

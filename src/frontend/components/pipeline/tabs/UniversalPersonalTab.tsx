...
export function UniversalPersonalTab({ record, recordType }: UniversalPersonalTabProps) {
  return (
    <div className="p-6 space-y-8">
      {/* Personal Profile */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Personal Intelligence</h3>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">{record?.timezone || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Preferred Language:</span>
                <span className="font-medium text-gray-900">{record?.preferredLanguage || 'English'}</span>
              </div>
            </div>
          </div>

          <div className="bg-green-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-3">Professional Background</h4>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-600">Years of Experience:</span>
                <span className="font-medium text-gray-900">{record?.yearsExperience || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Education:</span>
                <span className="font-medium text-gray-900">{record?.education || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Certifications:</span>
                <span className="font-medium text-gray-900">{record?.certifications || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Previous Companies:</span>
                <span className="font-medium text-gray-900">{record?.previousCompanies || '-'}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-2">
              {record?.interests?.length > 0 ? (
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                  <p className="text-gray-600 text-sm">No interests recorded yet</p>
                  <p className="text-gray-500 text-xs mt-1">Great conversation starters to discover</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {record?.hobbies?.length > 0 ? (
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                  <p className="text-gray-600 text-sm">No hobbies recorded yet</p>
                  <p className="text-gray-500 text-xs mt-1">Ask about weekend activities and interests</p>
                </div>
              )}
            </div>
          </div>
      ...
      {/* Goals & Aspirations */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Goals & Aspirations</h3>
        <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              {record?.professionalGoals?.length > 0 ? (
                ...
                <div>
                  ...
                  <p className="text-gray-500 italic mt-2">Ask about specific career aspirations</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">Personal Goals</h4>
            <div className="space-y-2 text-sm text-gray-700">
              {record?.personalGoals?.length > 0 ? (
                ...
                <div>
                  ...
                  <p className="text-gray-500 italic mt-2">Great topics for relationship building</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900">{record?.decisionMakingStyle || 'Analytical'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Communication:</span>
                <span className="font-medium text-gray-900">{record?.communicationStyle || 'Direct'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Meeting Style:</span>
                <span className="font-medium text-gray-900">{record?.meetingStyle || 'Structured'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Information Processing:</span>
                <span className="font-medium text-gray-900">{record?.processingStyle || 'Detail-oriented'}</span>
              </div>
            </div>
          </div>

          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-3">Relationship Building</h4>
            <div className="space-y-2 text-sm text-gray-700">
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Important Dates & Reminders</h3>

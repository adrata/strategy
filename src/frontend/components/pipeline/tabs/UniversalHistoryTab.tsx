      ...
      <div>
        ...
        <div className="space-y-4">
          {historyData.map((activity: any, index: number) => (
            <div key={activity.id || index} className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h4 className="font-semibold text-gray-900">{activity.subject || 'Activity'}</h4>
                      <p className="text-sm text-gray-600">{activity.type || 'Unknown'}</p>
                    </div>

...
export function UniversalDealIntelTab({ record, recordType }: UniversalDealIntelTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-500 mt-1">{record?.currency || 'USD'}</p>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-500 mt-1">Close probability</p>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-500 mt-1">Current deal stage</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Stage Entry:</span>
                <span className="font-medium text-gray-900">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Predicted Close:</span>
                <span className="font-medium text-gray-900">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-3">Activity Tracking</h4>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">Deal Analysis</h4>
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">Close Prediction</h4>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Acceleration Opportunities</h3>
        <div className="space-y-2">
          {record?.accelerationOpportunities?.length > 0 ? (
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <p className="text-gray-600 text-sm">No acceleration opportunities identified yet</p>
              <p className="text-gray-500 text-xs mt-1">AI will identify opportunities as deal progresses</p>
            </div>
          )}
        </div>
      </div>

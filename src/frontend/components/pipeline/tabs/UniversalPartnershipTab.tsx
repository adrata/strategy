...
export function UniversalPartnershipTab({ record, recordType, onSave }: UniversalPartnershipTabProps) {
  return (
    <div className="p-6 space-y-8">
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Partnership Intelligence</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-primary/10 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Partnership Type</h4>
            <div className="text-lg font-bold text-primary">
              {record?.partnershipType || 'Strategic'}
            </div>
            <p className="text-sm text-muted mt-1">Relationship category</p>
          </div>
          
          <div className="bg-success/10 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Partnership Since</h4>
          ...
          <div className="bg-info/10 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Partnership Value</h4>
            <div className="text-lg font-bold text-info">
              {record?.partnershipValue || 'High'}
            </div>
            <p className="text-sm text-muted mt-1">Strategic importance</p>
          </div>
        </div>
      </div>
      ...
      {/* Partnership Details */}
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Partnership Structure</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-panel-background rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-3">Partner Information</h4>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-foreground">{record?.size || record?.companySize || '-'}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-panel-background rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-3">Partnership Model</h4>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-muted">Model Type:</span>
                <span className="font-medium text-foreground">{record?.partnershipModel || 'Channel Partner'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted">Revenue Share:</span>
                <span className="font-medium text-foreground">{record?.revenueShare || '20%'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted">Territory:</span>
                <span className="font-medium text-foreground">{record?.territory || 'Regional'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted">Exclusivity:</span>
                <span className="font-medium text-foreground">{record?.exclusivity || 'Non-exclusive'}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Key Contacts */}
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Key Partner Contacts</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Partner Capabilities</h3>
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Core Competencies</h4>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Service Offerings</h4>
            <div className="space-y-2 text-sm text-gray-700">
      ...
      {/* Market Reach */}
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Market Reach & Influence</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-panel-background rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Geographic Reach</h4>
          ...
          <div className="bg-panel-background rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Customer Base</h4>
            <div className="space-y-1 text-sm text-muted">
          ...
          <div className="bg-panel-background rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-2">Market Position</h4>
            <div className="space-y-1 text-sm text-muted">
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-4">Mutual Benefits</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>

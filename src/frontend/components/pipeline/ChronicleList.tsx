    ...
    <div className="h-full w-full">
      ...
      <div className="p-6 border-b border-border">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Chronicle</h1>
            <p className="text-muted mt-1">Weekly reports and chronicles</p>
          </div>
      ...
      <div className="p-6">
        {reports.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted mb-4">Generate your first weekly report to get started.</p>
          ...
          <div className="space-y-4">
            {reports.map((report) => (
              <div
                ...
                className="bg-background rounded-lg border border-border p-6 hover:border-border hover:shadow-sm transition-all cursor-pointer"
              >

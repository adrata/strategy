        ...
        {isDropdownOpen && isClient && createPortal(
          <div ref={dropdownContentRef} className="fixed z-[9999] mt-1 w-64 bg-background border border-border rounded-lg shadow-lg" style={{
            ...
            <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => {
                      ...
                      if (hasFilterData(technologyOptions)) {
              ...
              {/* Technology Filter - Only show if options exist */}
              {hasFilterData(technologyOptions) && (
                <div className="mb-4">
                  <label className="block text-xs font-medium text-gray-700 mb-2">Technology</label>
                  <select

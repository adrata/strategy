// INDUSTRY INTELLIGENCE SYSTEM - Modularized Structure
// Original 1,309-line monolithic file has been split into focused modules

export * from "@/platform/services/industry-intelligence/index";

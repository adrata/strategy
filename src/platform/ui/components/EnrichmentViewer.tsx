            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 bg-panel-background rounded-lg">
                  <p className="text-sm text-muted">Total Emails</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {Object.entries(companyData.decisionMakerInsights).map(
                  ([role, count]) => (
                    <div key={role} className="p-4 bg-panel-background rounded-lg">
            ...
            <div>
              ...
              <div className="space-y-4">
                {companyData.sellerProfiles.map((profile: any) => (
                  <div key={profile.id} className="p-4 bg-panel-background rounded-lg">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="p-4 bg-panel-background rounded-lg">
              ...
              <p className="text-sm text-muted mt-2">Role</p>
          ...
          <div>
            ...
            <div className="space-y-4">
              {contactData.groups.map((group: any) => (
                <div key={group.id} className="p-4 bg-panel-background rounded-lg">
                  <h4 className="font-medium">{group.name}</h4>
                  <p className="text-sm text-muted">{group.company.name}</p>
                  {group['description'] && (
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-panel-background rounded-lg">
                <p className="text-sm text-muted">Decision Maker Roles</p>
                <div className="flex flex-wrap gap-2 mt-1">

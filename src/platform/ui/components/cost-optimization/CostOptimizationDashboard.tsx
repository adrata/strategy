    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted">Maximize margins for R&D reinvestment</p>
        </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-sm">
                      <span className="text-muted">Monthly ROI: </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted">60% cost reduction</p>
              </div>
            </Button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted">Save $150/month</p>
              </div>
            </Button>
          </div>
        </CardContent>

      ...
      <div className="bg-background rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground">Speedrun Engine</h2>
              <p className="text-muted">Intelligent Daily Prospect Prioritization</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          {activeTab === 'overview' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-4">Daily Intelligent Prioritization</h3>
          ...
          {activeTab === 'algorithm' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-4">How Daily Rankings Are Calculated</h3>
                <p className="text-muted mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    <h5 className="font-semibold text-foreground">Recency Score (30%)</h5>
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    <h5 className="font-semibold text-foreground">Business Value (25%)</h5>
                    <p className="text-sm text-muted">
                  ...
                  <div className="border-l-4 border-purple-500 pl-4">
                    <h5 className="font-semibold text-foreground">Engagement (20%)</h5>
                    <p className="text-sm text-muted">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-yellow-500 pl-4">
                    <h5 className="font-semibold text-foreground">Strategic Score (15%)</h5>
                    <p className="text-sm text-muted">
                  ...
                  <div className="border-l-4 border-red-500 pl-4">
                    <h5 className="font-semibold text-foreground">Urgency Score (10%)</h5>
                    <p className="text-sm text-muted">
              ...
              <div className="bg-panel-background p-6 rounded-lg">
                <h4 className="font-semibold text-foreground mb-3">Company-Based Ranking System</h4>
                <div className="space-y-2 text-sm">
          ...
          {activeTab === 'signals' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-4">Real-Time Signal Processing</h3>
                <p className="text-muted mb-6">
          ...
          {activeTab === 'optimizer' && (
            <div className="p-6">
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-foreground mb-2">Engine Configuration</h3>

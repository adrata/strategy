          ...
          {parsedRequest && !aiIntent && (
            <div className="mt-2 p-3 bg-blue-50 dark:bg-blue-950 rounded-md">
              <div className="text-sm">
                ...
                <span className="ml-2 text-gray-600">Confidence: {Math.round(parsedRequest.confidence * 100)}%</span>
              </div>
            </div>
          )}
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-xs text-gray-500 mt-1">Maximum number of companies to process</p>
              </div>

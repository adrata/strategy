  ...
  return (
    <div
      ...
      className={`
        ...
        ${isActive 
          ...
          : isSelected 
            ? 'border-border bg-panel-background shadow-sm' 
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs text-muted mb-2">
        ...
        <span className="text-muted">{theme.metadata.contrastRatio}:1</span>
      </div>
      ...
      {theme.metadata.tags.length > 0 && (
        <div className="flex flex-wrap gap-1 mt-3">
          {theme.metadata.tags.slice(0, 2).map((tag) => (
            <span
              key={tag}
              className="px-2 py-0.5 text-xs bg-hover text-muted rounded-md font-medium"
            >
              {tag}
            </span>
          ))}
  ...
  const categories = [
    ...
    { id: 'high-contrast', label: 'High Contrast', icon: Eye, count: filteredThemes.filter(t => t.category === 'high-contrast').length },
      ...
      return (
        ...
        <div
          ref={modalRef}
          className="w-full max-w-5xl bg-background rounded-lg shadow-lg border border-border overflow-hidden"
          role="dialog"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-border">
            <div>
              <h2 id="theme-picker-title" className="text-lg font-semibold text-foreground">
                Choose Theme
              </h2>
              <p id="theme-picker-description" className="text-sm text-muted mt-1">
          ...
          {/* Footer */}
          <div className="px-6 py-4 bg-panel-background border-t border-border">
            <div className="flex items-center justify-between text-sm text-muted">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-1 bg-loading-bg rounded text-xs">
                  {themeMode}
                </span>
              </div>
            </div>

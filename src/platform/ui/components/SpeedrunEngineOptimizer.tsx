...
export function SpeedrunEngineOptimizer({ isOpen, onClose, onApplyChanges }: SpeedrunEngineOptimizerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className={`bg-background dark:bg-foreground rounded-lg shadow-xl w-full mx-4 overflow-auto transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between p-6 border-b border-border dark:border-border">
          <div className="flex items-center gap-3">
            <BoltIcon className="w-6 h-6 text-foreground dark:text-white" />
            <div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 hover:bg-hover rounded-lg transition-colors"
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            {/* Sales Methodology Preset */}
            <div className="mb-8">
              <h3 className="text-lg font-medium text-foreground dark:text-white mb-4">Sales Methodology</h3>
                  ...
                  <button
                    ...
                    className={`p-3 rounded-lg border text-left transition-colors ${
                      settings['methodology'] === method
                        ? 'border-gray-900 dark:border-white bg-panel-background'
                        : 'border-border dark:border-border hover:bg-panel-background'
                    }`}
                  >
                    <div className="font-medium text-foreground dark:text-white capitalize">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-medium text-foreground dark:text-white mb-4">Sales Prioritization Engine</h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-loading-bg rounded-lg appearance-none slider slider-black"
                  />
            ...
            <div className="mb-8">
              <h3 className="text-lg font-medium text-foreground dark:text-white mb-4">Sales Methodology Tuning</h3>
              <p className="text-sm text-muted dark:text-muted mb-6">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-medium text-foreground dark:text-white mb-4">Pipeline Velocity Focus</h3>
              ...
              <div className="flex gap-2">
                {[
                  ...
                  >
                    <div className="font-medium text-foreground dark:text-white text-sm">{option.label}</div>
                    <div className="text-xs text-muted dark:text-muted mt-1">{option.subtitle}</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            {/* Daily & Weekly Targets */}
            <div className="mb-8">
              <h3 className="text-lg font-medium text-foreground dark:text-white mb-4">Daily & Weekly Targets</h3>
              <p className="text-sm text-muted dark:text-muted mb-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border dark:border-border rounded-lg bg-background text-foreground dark:text-white focus:ring-2 focus:ring-gray-900 dark:focus:ring-white focus:border-transparent"
                  />
            ...
            {/* Auto-Progression Settings */}
            <div className="mb-8">
              <h3 className="text-lg font-medium text-foreground dark:text-white mb-4">Auto-Progression Settings</h3>
              <p className="text-sm text-muted dark:text-muted mb-6">
                Configure how the engine automatically loads new batches of leads when you complete your targets.
              </p>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-panel-background rounded-lg border border-border dark:border-border">
                  <div>
                    <div className="font-medium text-foreground dark:text-white">Auto-pull Next Batch</div>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white focus:ring-offset-2 ${
                      settings.autoProgressToNextBatch ? 'bg-foreground dark:bg-background' : 'bg-loading-bg dark:bg-gray-600'
                    }`}
                  >
                    <span
                      className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-background dark:bg-foreground shadow ring-0 transition duration-200 ease-in-out ${
                ...
                <div>
                  ...
                  <p className="text-xs text-muted mt-1">Number of leads to load in each batch</p>
                </div>
              </div>
            </div>
            ...
            {isExpanded && (
              <div className="mb-8 p-4 bg-panel-background rounded-lg border border-border dark:border-border">
                <h3 className="text-lg font-medium text-foreground dark:text-white mb-4 flex items-center gap-2">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-sm text-muted dark:text-muted">{settings.championInfluence}%</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                      <div className="text-sm font-medium text-foreground dark:text-white mb-1">AI Recommendations</div>
                    ...
                    <div className="p-3 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                      <div className="text-sm font-medium text-foreground dark:text-white mb-1">Pipeline Strategy</div>
                      <div className="text-xs text-muted dark:text-muted">
          ...
          {/* Right Panel - Preview */}
          <div className="w-80 bg-panel-background border-l border-border dark:border-border p-6">
            <h3 className="text-lg font-medium text-foreground dark:text-white mb-4 flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                <div className="text-sm font-medium text-foreground dark:text-white mb-2">Primary Focus</div>
              ...
              <div className="p-4 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                <div className="text-sm font-medium text-foreground dark:text-white mb-2">Daily Targets</div>
                <div className="text-sm text-muted dark:text-muted">
                  <div className="flex justify-between mb-1">
                    <span>Daily:</span>
                    <span className="font-medium text-foreground dark:text-white">{settings.dailyTarget} leads</span>
                  </div>
                  <div className="flex justify-between mb-1">
                    <span>Weekly:</span>
                    <span className="font-medium text-foreground dark:text-white">{settings.weeklyTarget} leads</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Batch Size:</span>
                    <span className="font-medium text-foreground dark:text-white">{settings.batchSize} leads</span>
                  </div>
                </div>
              </div>

              <div className="p-4 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                <div className="text-sm font-medium text-foreground dark:text-white mb-2">Strategy</div>
                <div className="text-sm text-muted dark:text-muted">
              ...
              <div className="p-4 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                <div className="text-sm font-medium text-foreground dark:text-white mb-2">Auto-Progression</div>
                <div className="text-sm text-muted dark:text-muted">
              ...
              <div className="p-4 bg-background dark:bg-foreground rounded-lg border border-border dark:border-border">
                <div className="text-sm font-medium text-foreground dark:text-white mb-3">Top Factors</div>
                  ...
                  {[
                    ...
                    .map((factor) => (
                      <div key={factor.label} className="flex justify-between text-sm">
                        <span className="text-muted dark:text-muted">{factor.label}</span>
                        <span className="font-medium text-foreground dark:text-white">{factor.value}%</span>
                      </div>
                    ))}
                </div>
              </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between p-6 border-t border-border dark:border-border bg-panel-background">
          <div className="flex items-center gap-3">
            <button
              onClick={handleReset}
              className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-background border border-border dark:border-border rounded-lg hover:bg-panel-background dark:hover:bg-gray-600 transition-colors"
            >
              Reset to Default
            </button>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleApply}
              disabled={!hasChanges}
              className="px-6 py-2 text-sm font-medium text-white bg-foreground dark:bg-background dark:text-foreground rounded-lg hover:bg-gray-800 dark:hover:bg-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Apply Changes
            </button>
          </div>

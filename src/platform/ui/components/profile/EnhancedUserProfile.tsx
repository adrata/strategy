        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-3">
            ...
            {onClose && (
              <button
                onClick={onClose}
                className="px-4 py-2 border border-border text-gray-700 rounded-md hover:bg-panel-background"
              >
                Close
              </button>
            )}
...
function RolePermissionsTab({ 
  ...
  if (!roleConfig) {
    return (
      <div className="text-center py-8">
        <p className="text-muted">No role configuration found</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h4 className="text-md font-medium text-foreground mb-3">Permissions</h4>
      ...
      <div>
        <h4 className="text-md font-medium text-foreground mb-3">Default Applications</h4>
        <div className="flex flex-wrap gap-2">
          {roleConfig.defaultApps.map((app: string) => (
            <span key={app} className="bg-hover text-gray-800 px-3 py-1 rounded-full text-sm">
              {app}
            </span>
          ))}
        </div>
...
function PersonalizationTab({ 
  ...
  return (
    <div className="space-y-6">
      <div>
        <h4 className="text-md font-medium text-foreground mb-3">Communication Style</h4>
        <select
      ...
      <div>
        <h4 className="text-md font-medium text-foreground mb-3">Preferred Detail Level</h4>
        <select
      ...
      <div>
        <h4 className="text-md font-medium text-foreground mb-3">Intelligence Focus</h4>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="border border-border rounded-lg p-4">
          <h4 className="font-medium text-foreground mb-2">Account Access</h4>
        ...
        <div className="border border-border rounded-lg p-4">
          <h4 className="font-medium text-foreground mb-2">Contact Access</h4>
          <div className="text-sm text-muted space-y-1">
        ...
        <div className="border border-border rounded-lg p-4">
          <h4 className="font-medium text-foreground mb-2">CoreSignal Access</h4>
          <div className="text-sm text-muted space-y-1">
      ...
      <div>
        <h4 className="text-md font-medium text-foreground mb-3">Intelligence Features</h4>

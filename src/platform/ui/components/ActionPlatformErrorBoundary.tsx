          ...
          >
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full px-4 py-2 rounded-md flex items-center justify-center gap-2 text-sm font-medium bg-white/30 hover:bg-white/50 transition-colors"
              >
            ...
            {process['env']['NODE_ENV'] === "development" && (
              <details className="mt-4 text-xs">
                ...
                <pre className="bg-white/20 p-2 rounded text-xs overflow-auto max-h-32">

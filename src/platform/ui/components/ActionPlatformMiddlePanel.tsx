...
function SpeedrunMiddlePanelDB() {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: "flex-shrink-0 bg-gray-50 border-b" },
      React.createElement(
        'div',
        { className: "px-6 py-4" },
        React.createElement(
        ...
        ...contacts.map((contact) =>
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: "text-sm font-bold text-gray-600 bg-gray-100 px-2 py-1 rounded" },
              ...
              React.createElement(
                ...
                React.createElement(
                  'span',
                  { className: "px-3 py-1.5 bg-gray-100 text-gray-800 rounded-lg text-xs font-semibold" },
                  contact.status
                )
              )
            ),
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                { className: "p-3 bg-gray-50 border-l-4 border-gray-300 rounded-r-lg" },
                React.createElement(
                  'div',

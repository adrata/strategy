...
allThemes.forEach(theme => {
  themes[theme.id] = {
    ...
    "--overlay-bg": theme.colors.overlayBg,
    "--overlay-opacity": theme.colors.overlayOpacity,
    "--success-bg": theme.colors.successBg,
    "--success-text": theme.colors.successText,
    "--success-border": theme.colors.successBorder,
    "--warning-bg": theme.colors.warningBg,
    "--warning-text": theme.colors.warningText,
    "--warning-border": theme.colors.warningBorder,
    "--error-bg": theme.colors.errorBg,
    "--error-text": theme.colors.errorText,
    "--error-border": theme.colors.errorBorder,
    "--info-bg": theme.colors.infoBg,
    "--info-text": theme.colors.infoText,
    "--info-border": theme.colors.infoBorder,
    "--status-new-bg": theme.colors.statusNewBg,
    "--status-new-text": theme.colors.statusNewText,
    "--status-contacted-bg": theme.colors.statusContactedBg,
    "--status-contacted-text": theme.colors.statusContactedText,
    "--status-qualified-bg": theme.colors.statusQualifiedBg,
    "--status-qualified-text": theme.colors.statusQualifiedText,
    "--status-won-bg": theme.colors.statusWonBg,
    "--status-won-text": theme.colors.statusWonText,
    "--status-lost-bg": theme.colors.statusLostBg,
    "--status-lost-text": theme.colors.statusLostText,
    "--priority-high-bg": theme.colors.priorityHighBg,
    "--priority-high-text": theme.colors.priorityHighText,
    "--priority-medium-bg": theme.colors.priorityMediumBg,
    "--priority-medium-text": theme.colors.priorityMediumText,
    "--priority-low-bg": theme.colors.priorityLowBg,
    "--priority-low-text": theme.colors.priorityLowText,
  };
});

...
const IMPACT_INDICATORS = {
  low: { color: "bg-hover text-gray-700", label: "Minor" },
...
export function MagicalChanges({
  ...
  return (
    <div
      className={`bg-background/95 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl overflow-hidden ${className}`}
    >
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          ...
          {changes.length > 1 && (
            <button
              ...
              className="px-4 py-2 bg-background/20 text-white rounded-lg hover:bg-background/30 transition-colors text-sm font-medium"
            >
              Accept All ✨
            </button>
          )}
      ...
      <div className="p-4 space-y-4 max-h-96 overflow-y-auto">
        {changes.map((change) => {
          ...
          return (
            ...
            >
              <div className="flex items-start space-x-4 p-4 bg-panel-background rounded-xl hover:bg-hover transition-colors">
                {/* Magic Icon */}
                <div
                ...
                >
                  ...
                  <div className="absolute -top-1 -right-1 w-4 h-4 bg-background rounded-full flex items-center justify-center shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      disabled={isAnimating || isApproved}
                      className="flex items-center space-x-1 px-3 py-1.5 bg-loading-bg text-gray-700 rounded-lg hover:bg-gray-300 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      {/* Footer */}
      <div className="px-4 py-3 bg-panel-background border-t border-border">

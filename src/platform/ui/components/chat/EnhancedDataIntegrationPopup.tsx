...
export function EnhancedDataIntegrationPopup({ 
  ...
  return (
    <>
      ...
      {/* Enhanced popup */}
      <div className="absolute left-0 bottom-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl min-w-[500px] max-w-[700px] max-h-[600px] z-50 flex flex-col">
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-3 text-sm font-medium border-b-2 whitespace-nowrap transition-colors ${
                  isActive
                    ? `border-${category.color}-500 text-${category.color}-600 bg-white dark:bg-gray-800`
          ...
          {activeCategory === 'files' && (
            <div className="p-4">
                ...
                {FILE_OPTIONS.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center space-x-3 rounded-lg border border-gray-200 dark:border-gray-600 transition-colors"
                    >
              ...
              {recentFiles.length > 0 && (
                <div className="mt-6">
                  <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Recent Files</h4>

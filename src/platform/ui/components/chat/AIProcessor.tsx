...
export class AIProcessor {
  ...
  private buildContextualPrompt(input: string): string {
    const contextMap: Record<string, string> = {
      Speedrun: `You are an expert sales assistant for Adrata's Speedrun feature. SPEEDRUN IS THE DAILY LIST - the daily prioritized list of prospects to contact. It always exists (may be empty but Speedrun itself exists). Shows prospects ranked by strategic priority (Rank 1, Rank 2, etc.). When users say "Speedrun", "my list", "daily list", or "today's list" - they mean THIS existing list. NEVER say "Speedrun doesn't exist" or "you need to create Speedrun". Help users understand their daily list, prioritize prospects, suggest actions, and explain rankings.`,

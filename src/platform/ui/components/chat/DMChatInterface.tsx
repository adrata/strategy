...
export function DMChatInterface({ selectedDM, onBack }: DMChatInterfaceProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[var(--background)]">
      ...
      {/* Messages - Adrata AI chat style */}
      <div className="flex-1 overflow-y-auto px-6 py-0" style={{ 
      ...
      <div className="px-6 py-4 border-t border-[var(--border)] bg-[var(--background)]">
        <form onSubmit={handleSendMessage} className="flex items-end space-x-3">
          ...
          <button
            ...
            className="p-3 bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-lg hover:from-blue-500 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
          >

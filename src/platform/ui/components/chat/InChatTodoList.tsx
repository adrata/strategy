...
export function InChatTodoList({ 
  ...
  const getTaskStyle = (status: string) => {
    ...
    switch (status) {
      ...
      default:
        return `${baseStyle} bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400`;
    }
  };
  ...
  return (
    <div className={`bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 my-3 ${className}`}>
      {/* Header */}

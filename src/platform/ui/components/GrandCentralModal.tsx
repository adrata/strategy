      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Grand Central</h2>
              <p className="text-gray-600">Integration Hub & Data Connections</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          {activeTab === 'integrations' && (
            <div className="space-y-4">
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Active Integrations</h3>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            {integration['email'] && (
                              <p className="text-xs text-gray-500 mt-1">Connected: {integration.email}</p>
                            )}
            ...
            <div className="space-y-6">
                ...
                {integrations.filter(i => i['status'] === 'connected').map((integration) => (
                  <div key={integration.id} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <button
                      onClick={() => handleTest(integration)}
                      disabled={testingIntegration === integration.id}
                      className="mt-3 w-full px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded hover:bg-gray-200 transition-colors disabled:opacity-50"
                    >
              ...
              {integrations.filter(i => i['status'] === 'connected').length === 0 && (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Active Integrations</h3>
                  <p className="text-gray-600">Connect your data sources to enable sync monitoring</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">Email Sync Frequency</h4>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">Signal Detection</h4>

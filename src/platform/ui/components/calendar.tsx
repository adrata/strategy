  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-6 w-6 bg-transparent p-0 opacity-50 hover:opacity-100 rounded-sm hover:bg-hover"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-muted rounded-md w-8 h-8 flex items-center justify-center font-normal text-xs",
        row: "flex w-full",
        ...
        day: cn(
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 rounded-md hover:bg-hover flex items-center justify-center"
        ),
        day_selected:
          "bg-blue-500 text-white hover:bg-blue-600 focus:bg-blue-500 focus:text-white",
        day_today: "bg-primary text-[var(--accent-foreground)] font-semibold",
        day_outside:
          "text-muted opacity-50 aria-selected:bg-blue-100 aria-selected:text-blue-900 aria-selected:opacity-100",

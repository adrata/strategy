#!/usr/bin/env python3
"""
Comprehensive Clumio Buyer Group Analysis
...
def analyze_company_context(employees: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        'company_type': 'Product-Led' if engineering_percentage > sales_percentage else 'Sales-Led'
    }
...
def main():
    ...
    print("🔍 Analyzing Clumio Buyer Group Intelligence...")
    print("=" * 60)
    ...
    with open('clumio_buyer_group_report.json', 'w') as f:
        json.dump(report, f, indent=2)
    
    # Print summary
    print("\n📋 CLUMIO BUYER GROUP INTELLIGENCE REPORT")
    print("=" * 60)
    ...
    print(f"\n📁 Detailed report saved to: clumio_buyer_group_report.json")

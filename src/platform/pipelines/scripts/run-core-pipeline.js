 ...
 * 
 * Convenience wrapper to run the core pipeline from the root directory
...
async function runCorePipeline() {
    console.log('🚀 Running Core Pipeline...\n');
    ...
    try {
        execSync('node pipelines/core/core-pipeline.js', {
            cwd: __dirname,
            stdio: 'inherit',
        ...
        console.error('❌ Core Pipeline failed:', error.message);
        process.exit(1);
    }
}

...
interface UseAcquisitionOSUIReturn {
  // App & Section State
  activeSubApp: string;
...
/**
 * 🎨 ACQUISITION OS UI HOOK
 * Manages all UI state for AcquisitionOS
 ...
 * - Record selection
 */
export function useAcquisitionOSUI(): UseAcquisitionOSUIReturn {
...
export const useActionPlatformUI = useAcquisitionOSUI;

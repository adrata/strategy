...
interface UseAcquisitionOSAuthReturn {
  authUser: any;
...
/**
 * 🔐 ACQUISITION OS AUTH HOOK
 * Handles authentication for AcquisitionOS
 */
export function useAcquisitionOSAuth(): UseAcquisitionOSAuthReturn {
...
export const useActionPlatformAuth = useAcquisitionOSAuth;

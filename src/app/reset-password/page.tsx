      ...
      <div className="flex min-h-screen items-center justify-center bg-[var(--background)]">
        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md border">
          <div className="text-center">
            ...
            <Link
              href="/sign-in"
              className="w-full bg-[#2F6FDC] text-white py-2 px-4 rounded font-semibold hover:bg-[#4374DE] active:bg-[#4374DE] transition disabled:cursor-not-allowed disabled:bg-[#4374DE] text-center block"
            >
              Sign In
            </Link>
          </div>

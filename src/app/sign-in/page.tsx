        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded px-4 py-2 hover:border-[#2F6FDC] focus:ring-2 focus:ring-[#2F6FDC] focus:border-[#2F6FDC] outline-none invalid:border-gray-300 transition-colors"

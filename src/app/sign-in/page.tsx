        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded px-4 py-2 focus:ring-2 focus:ring-gray-500 focus:border-gray-500 outline-none invalid:border-gray-300"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-black text-white py-2 rounded font-semibold hover:bg-gray-800 transition disabled:cursor-not-allowed"
          >

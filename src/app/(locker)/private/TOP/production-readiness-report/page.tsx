              ...
              <div className="bg-gray-50 p-6 border-l-4 border-green-500">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">src/platform/services/unified-enrichment-system/index.ts</div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">src/platform/services/genius-level-intelligence-orchestrator.ts</div>
              ...
              <div className="bg-gray-50 p-6 border-l-4 border-blue-500">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">src/app/api/enrichment/unified/route.ts</div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">src/platform/services/professional-contact-validator.ts</div>

      ...
      <div className="space-y-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-400 p-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Buyer Group Intelligence:</h3>
              <div className="bg-white border rounded p-3">
                <p className="text-sm text-gray-600 mb-2">Generated using TOP's context model for utility communications:</p>

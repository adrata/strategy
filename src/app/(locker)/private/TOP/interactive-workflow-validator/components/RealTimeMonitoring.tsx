  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[var(--background)] rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">System Metrics</h3>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="text-center">
            <div className={`text-2xl font-bold ${getMetricColor(systemMetrics.cpuUsage)}`}>
              {systemMetrics.cpuUsage.toFixed(1)}%
            </div>
            <div className="text-sm text-[var(--muted)]">CPU Usage</div>
            <div className="w-full bg-[var(--loading-bg)] rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-[var(--muted)]">Memory Usage</div>
            <div className="w-full bg-[var(--loading-bg)] rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-[var(--muted)]">API Calls/sec</div>
            <div className="w-full bg-[var(--loading-bg)] rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-[var(--muted)]">Active Connections</div>
            <div className="w-full bg-[var(--loading-bg)] rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-[var(--muted)]">Error Rate</div>
            <div className="w-full bg-[var(--loading-bg)] rounded-full h-2 mt-2">
              <div 
      ...
      {/* API Performance */}
      <div className="bg-[var(--background)] rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">API Performance</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border border-[var(--border)] rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium text-[var(--foreground)]">CoreSignal API</h4>
          ...
          <div className="border border-[var(--border)] rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium text-[var(--foreground)]">Perplexity API</h4>
              <span className="text-green-600 text-sm">✅ Online</span>
            </div>
            <div className="text-sm text-[var(--muted)]">
          ...
          <div className="border border-[var(--border)] rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium text-[var(--foreground)]">ZeroBounce API</h4>
              <span className="text-green-600 text-sm">✅ Online</span>
            </div>
            <div className="text-sm text-[var(--muted)]">
      ...
      <div className="bg-[var(--background)] rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Real-time Activity</h3>
        <div className="bg-[var(--foreground)] text-green-400 p-4 rounded-lg font-mono text-sm max-h-64 overflow-auto">
              ...
              <div key={index} className="mb-2 flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  {data.status === 'completed' && data.duration && (
                    <span className="text-[var(--muted)] ml-2">({data.duration}ms)</span>
                  )}
                  {data.dataSource && (
      ...
      <div className="bg-[var(--background)] rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Parallel Processing Status</h3>
      ...
      <div className="bg-[var(--background)] rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Data Sources & Confidence</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h4 className="font-medium text-[var(--foreground)] mb-2">Data Sources</h4>
          ...
          <div>
            <h4 className="font-medium text-[var(--foreground)] mb-2">Overall Quality</h4>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">

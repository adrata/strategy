    ...
    <PasswordProtection correctPassword="Fortune500Snyk!">
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          <h1 className="text-2xl font-semibold text-gray-900 mb-4">Private Message for Snyk</h1>
          <p className="text-gray-600 mb-8">Access granted. Redirecting you to your confidential business case...</p>

    ...
    <div className="min-h-screen bg-panel-background flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-background rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">Winning Variant Access</h1>
          <p className="text-muted">Enter the access code to view the Buyer Group Intelligence Reports</p>
        </div>

      ...
      <div className="min-h-screen bg-[var(--background)]" style={{ overflowY: 'auto', height: '100vh' }}>
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="border-b-2 border-black pb-8 mb-12">
            ...
            <div className="flex items-center space-x-8 text-sm text-[var(--muted)]">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-black mb-6 border-b border-[var(--border)] pb-2">
              Executive Summary
            </h2>
            <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6 mb-6">
              <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Key Intelligence</h3>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Professional Background</h3>
              ...
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Decision-Making Context</h3>
                <ul className="space-y-3 text-gray-700">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-8">
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Mission & Core Functions</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Technology Challenges</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Regulatory Environment</h3>
                <ul className="space-y-2 text-gray-700">
          ...
          <section className="mb-12">
            ...
            <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6 mb-8">
              <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Key Research Findings</h3>
            ...
            <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6">
              <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Recruitment Opportunities</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">High-Value Use Cases</h3>
                <ul className="space-y-3 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Competitive Advantages</h3>
                <ul className="space-y-3 text-gray-700">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Phase 1: Discovery & Relationship Building</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Phase 2: Solution Demonstration</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Phase 3: Proposal & Implementation</h3>
                <ul className="space-y-2 text-gray-700">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-4">
                <h4 className="font-semibold text-[var(--foreground)] mb-2">NCDOT Experience Alignment</h4>
              ...
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-4">
                <h4 className="font-semibold text-[var(--foreground)] mb-2">Case Management System Support</h4>
              ...
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-4">
                <h4 className="font-semibold text-[var(--foreground)] mb-2">PMP-Certified Project Management</h4>
              ...
              <div className="space-y-6">
                <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-4">
                  <h4 className="font-semibold text-[var(--foreground)] mb-2">Data Analytics & Reporting</h4>
                ...
                <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-4">
                  <h4 className="font-semibold text-[var(--foreground)] mb-2">Government IT Expertise</h4>
                ...
                <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-4">
                  <h4 className="font-semibold text-[var(--foreground)] mb-2">Poole College Network</h4>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Potential Risks</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] border-l-4 border-gray-400 p-6">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-3">Mitigation Strategies</h3>
                <ul className="space-y-2 text-gray-700">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Target Contact</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-[var(--panel-background)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">CloudCaddie Resources</h3>
                <ul className="space-y-2 text-gray-700">
          ...
          {/* Footer */}
          <footer className="border-t border-[var(--border)] pt-8 mt-12">

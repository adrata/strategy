        ...
        <header className="border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              <h1 className="text-lg font-semibold text-foreground">Absorb Adrata</h1>
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-black pl-4">
                    ...
                    <p className="text-sm text-muted mb-3">Budget authority and final approval for LMS decisions</p>
                  ...
                  <div className="border-l-4 border-black pl-4">
                    ...
                    <p className="text-sm text-muted mb-3">Oversees HR, culture, talent retention & acquisition, DEI at athenahealth</p>
                    <div className="text-sm text-gray-700 space-y-2">
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-gray-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Internal advocate for LMS change and improvement</p>
                  ...
                  <div className="border-l-4 border-gray-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">11+ yrs tenure, based in Boston alongside Nikki</p>
                    <div className="text-xs text-muted">
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-gray-400 pl-4">
                    ...
                    <p className="text-sm text-muted">14+ years at athenahealth, key influencer in LMS selection process</p>
                    <p className="text-xs text-muted"><strong>Influence:</strong> High - Long tenure and solution design expertise provides significant influence on LMS selection and implementation decisions</p>
                  </div>
                  <div className="border-l-4 border-gray-400 pl-4">
                    <h5 className="font-semibold text-black">Erica Canuto (Manager Platform Services & Solutions)</h5>
                    <p className="text-sm text-muted">Based in Boston, key influencer in LMS selection process</p>
                    <p className="text-xs text-muted"><strong>Influence:</strong> Medium - Platform services expertise provides operational influence on training processes and user experience</p>
                  </div>
                  <div className="border-l-4 border-gray-400 pl-4">
                    <h5 className="font-semibold text-black">Emily Anderson (Marketing And Events Coordinator)</h5>
                    <p className="text-sm text-muted">Key influencer in LMS selection process</p>
                    <p className="text-xs text-muted"><strong>Influence:</strong> Medium - Stakeholder influence on training effectiveness and user satisfaction</p>
                  </div>
                </div>
              </div>
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Now SVP HR for OncoHealth - Leverage to get inside baseball on athenahealth prior to activating Priya</p>
                    <div className="text-xs text-muted">
                  ...
                  <div className="border-l-4 border-blue-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">12+ years at athenahealth, now sales specialist at Snowflake based in Boston - Get him to vent about issues with training reps</p>
                    <div className="text-xs text-muted">

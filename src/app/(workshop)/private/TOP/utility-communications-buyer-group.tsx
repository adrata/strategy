      ...
      <div className="space-y-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-400 p-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="font-semibold text-foreground">Existing Contacts Found:</h3>
            ...
            <div>
              <h3 className="font-semibold text-foreground">Buyer Group Intelligence:</h3>
              <div className="bg-background border rounded p-3">
                <p className="text-sm text-muted mb-2">Generated using TOP's context model for utility communications:</p>

  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-background">
      <div className="mb-6">
        ...
        <p className="text-muted">Complete System Validation Report</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-background border rounded p-4">
          <h2 className="text-lg font-semibold text-foreground mb-4">Use Cases Validated</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Utility Communications Buyer Group Research</h3>
                <p className="text-sm text-muted">Idaho Power Company - Found 3 existing contacts, identified buyer group roles, employment verification</p>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Prospect Enrichment Research</h3>
                <p className="text-sm text-muted">Chris Mantle at Puget Sound Energy - Complete profile enrichment with employment verification</p>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Find Communications Engineer</h3>
                <p className="text-sm text-muted">NV Energy SCADA engineer search - Found 3 high-relevance candidates with 91% average match score</p>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Competitor Intelligence Research</h3>
                <p className="text-sm text-muted">Tri-State Generation project - Identified 9 competitors, leveraged 8 existing contacts for advantage</p>
        ...
        <div className="bg-background border rounded p-4">
          <h2 className="text-lg font-semibold text-foreground mb-4">System Performance Metrics</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted">Real Data Usage</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">89%</div>
              <div className="text-sm text-muted">Average Accuracy Score</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">4/4</div>
              <div className="text-sm text-muted">Use Cases Validated</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-background border rounded p-4">
          <h2 className="text-lg font-semibold text-foreground mb-4">TOP Context Model Validation</h2>

      ...
      <div className="space-y-6">
        ...
        <div className="bg-green-50 border-l-4 border-green-400 p-4">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-semibold text-foreground">Contact Found in Database:</h3>
            ...
            <div>
              <h3 className="font-semibold text-foreground">Role & Responsibility Analysis:</h3>
              <div className="bg-background border rounded p-3">
                <p className="text-sm text-muted mb-2">Based on PSE organizational structure and utility industry patterns:</p>
            ...
            <div>
              <h3 className="font-semibold text-foreground">Company Context - Puget Sound Energy:</h3>
              <div className="bg-background border rounded p-3">
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-foreground">Engagement History:</h3>
              <div className="bg-background border rounded p-3">
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-foreground">Recommended Approach:</h3>

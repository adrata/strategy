  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-background rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="text-center">
            ...
            <div className="w-full bg-loading-bg rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted">Memory Usage</div>
            <div className="w-full bg-loading-bg rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted">API Calls/sec</div>
            <div className="w-full bg-loading-bg rounded-full h-2 mt-2">
              <div 
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted">Error Rate</div>
            <div className="w-full bg-loading-bg rounded-full h-2 mt-2">
              <div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border border-border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium text-foreground">CoreSignal API</h4>
          ...
          <div className="border border-border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium text-foreground">ZeroBounce API</h4>
              <span className="text-green-600 text-sm">✅ Online</span>
            </div>
            <div className="text-sm text-muted">
      ...
      <div className="bg-background rounded-lg shadow-sm p-6">
        ...
        <div className="bg-foreground text-green-400 p-4 rounded-lg font-mono text-sm max-h-64 overflow-auto">
              ...
              <div key={index} className="mb-2 flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  {data.status === 'completed' && data.duration && (
                    <span className="text-muted ml-2">({data.duration}ms)</span>
                  )}
                  {data.dataSource && (
      ...
      <div className="bg-background rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">Parallel Processing Status</h3>
      ...
      <div className="bg-background rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">Data Sources & Confidence</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <h4 className="font-medium text-foreground mb-2">Overall Quality</h4>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">

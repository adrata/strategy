    ...
    <PasswordProtection correctPassword="SBI-Flexera-2025">
      <div className="min-h-screen bg-background" style={{ overflowY: 'auto', height: '100vh' }}>
        ...
        <header className="border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              <h1 className="text-lg font-semibold text-foreground">SBI Growth Adrata</h1>
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-black pl-4">
                    ...
                    <p className="text-sm text-muted mb-3">Ultimate decision authority for strategic initiatives</p>
                  ...
                  <div className="border-l-4 border-border pl-4">
                    ...
                    <p className="text-sm text-muted mb-3">Financial gatekeeper and ROI validator</p>
                    <div className="text-sm text-gray-700 space-y-2">
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-green-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Primary champion with 7 years tenure and direct RevOps alignment</p>
                  ...
                  <div className="border-l-4 border-gray-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Growth strategy champion and market expansion advocate</p>
                    <div className="text-xs text-muted">
                  ...
                  <div className="border-l-4 border-gray-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Sales process champion and revenue impact advocate</p>
                    <div className="text-xs text-muted">
                  ...
                  <div className="border-l-4 border-gray-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Marketing strategy champion and brand positioning advocate</p>
                    <div className="text-xs text-muted">
                  ...
                  <div className="border-l-4 border-gray-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Customer success champion and retention advocate</p>
                    <div className="text-xs text-muted">
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-gray-400 pl-4">
                    ...
                    <p className="text-sm text-muted">Operational execution and team alignment</p>
                    <p className="text-xs text-muted"><strong>Influence:</strong> Implementation feasibility and operational impact assessment</p>
                  </div>

                  <div className="border-l-4 border-gray-400 pl-4">
                    <h5 className="font-semibold text-black">EL Lages (Chief People Officer)</h5>
                    <p className="text-sm text-muted">Organizational change and team development</p>
                    <p className="text-xs text-muted"><strong>Influence:</strong> Change management and organizational readiness</p>
                  </div>

                  <div className="border-l-4 border-gray-400 pl-4">
                    <h5 className="font-semibold text-black">Thomas Charles Davis, Jr (Technology Operating Partner, Thoma Bravo)</h5>
                    <p className="text-sm text-muted">Strategic opener with VC/PE influence and direct buyer group access</p>
                    <p className="text-xs text-muted"><strong>Strategic Value:</strong> Primary investor relationship (Thoma Bravo purchased Flexera in 2008, reacquired controlling stake in 2020 for $2.85B with KKR as financier). Direct connection to Anthony Erickson (Head of Commercial Sales at SBI) provides warm introduction pathway to Flexera buyer group.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-red-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Primary blocker with threat perception and territorial concerns</p>
                  ...
                  <div className="border-l-4 border-red-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Operational efficiency gatekeeper and change resistance advocate</p>
                    <div className="text-sm text-gray-700">
                  ...
                  <div className="border-l-4 border-red-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Vendor evaluation and contract negotiation gatekeepers</p>
                    <div className="text-sm text-gray-700">
                  ...
                  <div className="border-l-4 border-red-500 pl-4">
                    ...
                    <p className="text-sm text-muted mb-2">Budget allocation and financial approval authority</p>
                    <div className="text-sm text-gray-700">
          ...
          {/* Next Steps */}
          <section className="mb-12">
            <div className="bg-panel-background border border-border p-8 rounded-lg">

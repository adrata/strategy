...
export default function SnykBusinessCasePage() {
  ...
  return (
    <PasswordProtection correctPassword="Fortune500Snyk!">
      <div className="min-h-screen bg-background" style={{ overflowY: 'auto', height: 'auto' }}>
        {/* Header */}
        <header className="border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
            <h1 className="text-lg font-semibold text-foreground">Adrata</h1>
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="border-b-2 border-black pb-8 mb-12">
                ...
                isEditing ? (
                  <span className="inline-flex items-center">
                    $<input
                      ...
                      className="w-20 px-2 py-1 border border-gray-400 rounded text-gray-800 bg-background focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                      autoFocus
                      min="0"
                      max="9999"
                      placeholder="370"
            ...
            <div className="bg-panel-background p-6 rounded-lg border-l-4 border-gray-400">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <p className="text-xs font-semibold text-muted uppercase tracking-wide">Strategic Impact</p>
          ...
          <section className="mb-12">
            ...
            <div className="bg-panel-background border border-border p-4 rounded-lg mb-6">
              <p className="text-sm text-gray-700">
                <strong className="text-foreground">The Hard Truth:</strong> Enterprise B2B buying groups now average 11+ stakeholders per decision (2024)<sup>1</sup>, and 65% of deals continue to fail due to unidentified stakeholders with veto power<sup>2</sup>. Your current tools provide data, but not the buyer group intelligence needed to navigate today's complex decision-making reality.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div className="bg-panel-background p-4 rounded-lg text-center border border-border">
                ...
                <div className="text-sm text-muted">Annual Savings</div>
              </div>
              <div className="bg-panel-background p-4 rounded-lg text-center border border-border">
                <div className="text-3xl font-bold text-black">40%</div>
                <div className="text-sm text-muted">Faster Deal Velocity</div>
              </div>
              <div className="bg-panel-background p-4 rounded-lg text-center border border-border">
                <div className="text-3xl font-bold text-black">$7.1M</div>
                <div className="text-sm text-muted">Additional Revenue</div>
              </div>
              <div className="bg-panel-background p-4 rounded-lg text-center border border-border">
                <div className="text-3xl font-bold text-black">{CURRENT_STACK_COST}+</div>
                <div className="text-sm text-muted">Current Stack Cost (Est.)</div>
              </div>
            </div>
          </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="border-l-4 border-gray-400 pl-4">
                    ...
                    <div className="text-sm text-muted">of B2B buyers need additional resources from vendors during complex purchase evaluation</div>
                    <div className="text-xs text-muted">Source: Foundry Research, 2024<sup>2</sup></div>
                  </div>
                  
                  <div className="border-l-4 border-gray-400 pl-4">
                    <div className="text-2xl font-bold text-black">68%</div>
                    <div className="text-sm text-muted">say brand awareness across all stakeholders makes internal selling easier</div>
                    <div className="text-xs text-muted">Source: Foundry Research, 2024<sup>3</sup></div>
                  </div>
                  
                  <div className="border-l-4 border-gray-400 pl-4">
                    <div className="text-2xl font-bold text-black">81% → 35%</div>
                    <div className="text-sm text-muted">purchase likelihood drops from 1 decision maker to 6+ stakeholders</div>
                    <div className="text-xs text-muted">Source: CEB Research (The Challenger Customer)<sup>4</sup></div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-gray-400 pl-4">
                    ...
                    <div className="text-sm text-muted">of younger buyers include 10+ external influencers in purchase decisions</div>
                    <div className="text-xs text-muted">Source: Forrester Predictions 2025<sup>5</sup></div>
                  </div>
                  
                  <div className="border-l-4 border-gray-400 pl-4">
                    <div className="text-2xl font-bold text-black">87%</div>
                    <div className="text-sm text-muted">of buyers using AI reported better business outcomes</div>
                    <div className="text-xs text-muted">Source: Forrester Research, 2024<sup>6</sup></div>
                  </div>
                  
                  <div className="border-l-4 border-gray-400 pl-4">
                    <div className="text-2xl font-bold text-black">$591B</div>
                    <div className="text-sm text-muted">wasted annually on futile sales meetings due to poor stakeholder mapping</div>
                    <div className="text-xs text-muted">Source: Challenger Inc. Research<sup>7</sup></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-sm text-muted">{SALES_NAVIGATOR_COST}/year</span>
                </div>
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-sm text-muted">{SIXSENSE_COST}/year</span>
                </div>
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-sm text-muted">{MADKUDU_COST}/year</span>
                </div>
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-sm text-muted">{WINN_AI_COST}/year</span>
                </div>
              ...
              <div className="bg-background border border-border p-6 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-sm text-muted">{ZOOMINFO_COST}/year</span>
                </div>
            ...
            <div className="bg-panel-background border border-border p-6 rounded-lg mt-6">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-background border border-border p-6 rounded-lg">
                ...
                <div className="bg-panel-background p-3 rounded text-xs text-gray-700">
            ...
            <div className="bg-panel-background border-2 border-gray-400 p-6 rounded-lg text-center">
          ...
          <section className="mb-12">
            ...
            <div className="bg-green-50 border-2 border-green-400 p-6 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-background p-4 rounded-lg border border-green-300">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-background p-4 rounded border border-green-300 text-center">
          ...
          <div className="bg-black text-white p-8 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-background text-black p-4 rounded-lg">
        ...
        {/* Footnotes */}
        <section className="bg-panel-background py-12">
        ...
        {/* Footer */}
        <footer className="bg-panel-background border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-6 py-6 text-center">
            <h3 className="text-lg font-semibold text-foreground mb-4">Adrata - Buyer Group Intelligence Platform</h3>
            ...
            <p className="text-xs text-muted">© 2025 Adrata. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </PasswordProtection>

    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-80 border-r border-gray-200 bg-gray-50 overflow-y-auto">
          <div className="p-4">
            <h3 className="font-medium text-gray-900 mb-3">Query History</h3>
            {history.length === 0 ? (
        ...
        <div className="flex-1 overflow-y-auto">
            ...
            <div className="p-6">
              ...
              {result.data.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">The query executed successfully but returned no data.</p>
                </div>
              )}
            </div>
          )}
          ...
          {!loading && !error && !result && (
            <div className="p-6 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Ready to execute queries</h3>

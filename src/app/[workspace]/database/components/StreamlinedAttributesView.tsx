        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-4">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="bg-panel-background border border-border rounded-lg">
                ...
                <div className="p-4">
                  <div className="space-y-2">
                    {Array.from({ length: 4 }).map((_, fieldIndex) => (
                      <div key={fieldIndex} className="flex items-center justify-between p-2 border border-border rounded">
                        <div className="flex items-center gap-2">
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-shrink-0 px-6 py-4 border-b border-border">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Attributes</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6" style={{ 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {models.map((model) => (
            <div key={model.name} className="bg-panel-background border border-border rounded-lg p-4 hover:bg-hover cursor-pointer transition-colors shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted">Primary Keys:</span>

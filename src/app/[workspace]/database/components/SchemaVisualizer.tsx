    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading schema visualization...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-shrink-0 p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Schema Visualizer</h1>
            <p className="text-gray-600">Interactive database schema overview</p>
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-6xl mx-auto">
          {/* Schema Overview */}
          <div className="mb-8">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Database Schema Overview</h2>

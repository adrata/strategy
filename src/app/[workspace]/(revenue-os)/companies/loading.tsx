  ...
  return (
    <div className="h-full w-full bg-background animate-pulse">
      <div className="border-b border-border bg-card p-4">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <div className="h-4 w-36 bg-hover rounded" />
          </div>
      ...
      <div className="px-4 space-y-1">
        {[...Array(10)].map((_, i) => (
          <div key={i} className="h-14 bg-card border border-border rounded flex items-center gap-4 px-4" style={{ opacity: 1 - (i * 0.08) }}>
            <div className="h-4 w-36 bg-hover rounded" />

    ...
    return (
      <div className="h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-muted mb-6">{error || 'Seller not found'}</p>
          <button 
                  ...
                  <div className="h-full flex flex-col bg-background">
                    ...
                    <div className="flex-shrink-0 bg-background border-b border-border px-6 py-3">
                      <div className="flex items-center gap-2">
                        <button 
                          onClick={() => window.history.back()}
                          className="flex items-center gap-1 text-sm text-muted hover:text-gray-700 transition-colors"
                        >
                        ...
                        <span className="text-sm text-muted">{seller.name}</span>
                        <span className="text-sm text-muted">/</span>
                    ...
                    <div className="flex-shrink-0 border-b border-border px-6 py-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          {/* Avatar */}
                          <div className="w-12 h-12 bg-background border border-border rounded-2xl flex items-center justify-center shadow-sm">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted">{seller.role || 'Sales Representative'} • {workspace}</p>
                          </div>
                        </div>
                      ...
                      <div className="mt-4 flex items-center gap-6">
                        <div className="text-center">
                          <div className="text-lg font-semibold text-foreground">{companies.length}</div>
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-muted">Closed Won</div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {companies.map((company) => (
                            <div
                              ...
                              className="group bg-background border border-border rounded-lg p-6 hover:shadow-md hover:border-blue-300 cursor-pointer transition-all duration-200"
                            >
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-2">
                                    <h4 className="font-semibold text-foreground text-lg group-hover:text-blue-700 transition-colors">
                                      {company.name}
                                    </h4>

                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 capitalize">{chart.type} Chart</p>
                      </div>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
          ...
          {charts.length === 0 ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-4">Create your first chart to get started</p>
                <button
                  onClick={() => setShowAddChart(true)}
            ...
            <div className="p-6">
              <div className="relative" style={{ width: '100%', height: '100%' }}>
                {charts.map((chart) => (
                  <div
                    key={chart.id}
                    className={`absolute border-2 rounded-lg bg-white shadow-lg ${
                      selectedChart === chart.id ? 'border-blue-500' : 'border-gray-200'
                    }`}
                    style={{
                      left: chart.x,
                      top: chart.y,
      ...
      {showAddChart && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onClick={() => setShowAddChart(false)} />
            
            <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900">Add Chart</h3>
                <button
                ...
                <div className="grid grid-cols-2 gap-4">
                  {chartTypes.map((type) => (
                    <button
                      ...
                      className="p-4 text-left border border-gray-200 rounded-lg hover:border-blue-300 hover:shadow-md transition-all group"
                    >

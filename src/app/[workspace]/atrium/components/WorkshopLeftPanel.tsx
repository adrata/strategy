    ...
    return (
      <div className="w-[13.085rem] min-w-[13.085rem] max-w-[13.085rem] bg-background text-foreground border-r border-border flex flex-col h-full">
        <div className="p-4 text-center">
          <div className="text-sm text-muted">Loading Workshop...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="w-[13.085rem] min-w-[13.085rem] max-w-[13.085rem] bg-background text-foreground border-r border-border flex flex-col h-full">
      ...
      <div className="flex-shrink-0 p-4 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-semibold text-foreground">Workshop</h2>
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        ...
        <div className="pt-4 space-y-1">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-panel-background text-foreground transition-colors border border-border"
          >

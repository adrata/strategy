          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <div className="flex items-center mb-1">
                ...
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-hover text-foreground">
                  Help
                </span>
              </div>
        ...
        <div className="mx-2 mb-4 p-3 bg-hover rounded-lg border border-border">
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-xs font-medium text-muted">Guides</span>
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${
                    isActive
                      ...
                      : 'hover:bg-panel-background text-muted'
                  }`}
                >
      ...
      <div className="flex-shrink-0 p-2" style={{ paddingBottom: '15px' }}>
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <div className="text-xs text-muted">Action Guide</div>
          </div>
        </button>
      </div>
    </div>

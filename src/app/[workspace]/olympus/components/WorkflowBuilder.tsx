    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border bg-panel-background">
        <div className="flex items-center gap-4">
          <h2 className="text-lg font-semibold text-foreground">CFO/CRO Discovery Pipeline</h2>
          <div className="flex items-center gap-2">
            <span className="text-sm text-muted">Nodes: {state.nodes.length}</span>
            <span className="text-sm text-muted">Connections: {state.connections.length}</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
      ...
      <div 
        ref={canvasRef}
        className="flex-1 relative overflow-hidden bg-panel-background"
        style={{
            ...
            >
              ...
              <div className="flex items-center justify-between mt-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-muted capitalize">{node.status}</span>
                </div>
      ...
      {/* Status Bar */}
      <div className="flex items-center justify-between px-4 py-2 border-t border-border bg-panel-background text-sm text-muted">
        <div className="flex items-center gap-4">

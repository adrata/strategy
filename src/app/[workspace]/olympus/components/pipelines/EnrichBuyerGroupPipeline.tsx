    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-shrink-0 px-6 py-3 bg-white border-b border-border">
        <nav className="flex items-center space-x-2 text-sm">
          ...
          <span className="text-foreground">/</span>
          <span className="text-foreground font-medium">Enrich</span>
        </nav>
      </div>
      ...
      <div className="flex-shrink-0 px-6 py-4 border-b border-border bg-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Enrich Buyer Group</h1>
              <p className="text-sm text-foreground">Add intelligence layers to existing buyer groups</p>
            </div>
          </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/3 border-r border-border bg-white overflow-y-auto overflow-x-hidden scrollbar-hide">
          <div className="p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-foreground">Set up your buyer group enrichment parameters</p>
            </div>
            <ContextSelector
              inputMode={inputMode}
        ...
        <div className="flex-1 bg-white overflow-y-auto overflow-x-hidden scrollbar-hide">
          <div className="p-6">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-foreground mb-2">Enrichment Progress</h3>
              <p className="text-sm text-foreground">Track the execution of your buyer group enrichment</p>
            </div>

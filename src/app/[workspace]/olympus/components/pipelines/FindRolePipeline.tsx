              ...
              <div key={index} className="bg-[var(--hover)] border border-[var(--border)] rounded-lg p-4">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <h4 className="font-semibold text-[var(--foreground)]">{person.name}</h4>
                    <p className="text-sm text-[var(--muted)]">{person.title} at {person.company}</p>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="bg-[var(--background)] border border-[var(--border)] rounded p-3">
                    <div className="text-[var(--muted)] text-xs">Seniority</div>
                    <div className="font-semibold text-[var(--foreground)]">{person.seniorityScore}</div>
                  </div>
                  <div className="bg-[var(--background)] border border-[var(--border)] rounded p-3">
                    <div className="text-[var(--muted)] text-xs">Company Fit</div>
                    <div className="font-semibold text-[var(--foreground)]">{person.companyFitScore}</div>
                  </div>
                  <div className="bg-[var(--background)] border border-[var(--border)] rounded p-3">
                    <div className="text-[var(--muted)] text-xs">Role Relevance</div>
                    <div className="font-semibold text-[var(--foreground)]">{person.roleRelevanceScore}</div>
                  </div>
                </div>

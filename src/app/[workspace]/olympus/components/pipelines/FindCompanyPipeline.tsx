            ...
            {results.map((company, index) => (
              <div key={index} className="bg-[var(--hover)] border border-[var(--border)] rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-[var(--foreground)]">{company.companyName}</h4>
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-[var(--muted)]">TCI Score:</span>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-[var(--muted)]">Industry:</span> {company.industry}
                  </div>
                  <div>
                    <span className="text-[var(--muted)]">Employees:</span> {company.employeeCount.toLocaleString()}
                  </div>
                  <div>
                    <span className="text-[var(--muted)]">Innovation Profile:</span> {company.innovationProfile}
                  </div>
                  <div>
                    <span className="text-[var(--muted)]">Buyer Group Quality:</span> {company.buyerGroupQuality}%
                  </div>
                </div>
                <div className="mt-2">
                  <span className="text-[var(--muted)] text-sm">Pain Signals:</span>

  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="p-4 border-b border-border">
        ...
        <p className="text-sm text-muted">Configure API keys, settings, and limits for the CFO/CRO discovery pipeline</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {activeTab === 'apis' && (
          <div className="p-4 space-y-4">
            {Object.entries(configs).map(([apiId, config]) => (
              <div key={apiId} className="border border-border rounded-lg p-4">
        ...
        {activeTab === 'settings' && (
          <div className="p-4 space-y-6">
            <div className="border border-border rounded-lg p-4">
              <h3 className="font-medium text-foreground mb-3">Execution Settings</h3>
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="border border-border rounded-lg p-4">
              <h3 className="font-medium text-foreground mb-3">Retry Settings</h3>
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Max Retry Attempts
        ...
        {activeTab === 'limits' && (
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-3">
              {Object.entries(configs).map(([apiId, config]) => (
                <div key={apiId} className="border border-border rounded-lg p-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium text-foreground">{config.name}</h4>
                      <p className="text-sm text-muted">Cost: ${config.costPerCall} | Limit: {config.rateLimit}/hr</p>
                    </div>
                    <div className={`px-2 py-1 rounded text-xs font-medium ${
                      config.enabled ? 'bg-green-100 text-green-800' : 'bg-hover text-gray-800'
                    }`}>
      ...
      {/* Footer */}
      <div className="p-4 border-t border-border bg-panel-background">
        <div className="flex items-center justify-between">

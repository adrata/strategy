    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-background rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div>
            <h2 className="text-xl font-semibold text-foreground">Configure Pipeline Start</h2>
            <p className="text-sm text-muted mt-1">Set up your CFO/CRO discovery pipeline parameters</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Target Roles */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-foreground">Target Roles</h3>
          ...
          {/* Custom Instructions */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-foreground">Custom Instructions (Optional)</h3>
            <textarea
        ...
        <div className="flex items-center justify-between p-6 border-t border-border bg-panel-background">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2 text-muted hover:text-gray-800 transition-colors"
            >
              Cancel
            </button>
            <button

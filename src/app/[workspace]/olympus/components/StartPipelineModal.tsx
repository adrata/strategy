    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Configure Pipeline Start</h2>
            <p className="text-sm text-gray-600 mt-1">Set up your CFO/CRO discovery pipeline parameters</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Custom Instructions */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-gray-900">Custom Instructions (Optional)</h3>
            <textarea

...
interface ApiContextType {
  ...
  activeTab: 'keys' | 'usage' | 'documentation' | 'webhooks' | 'settings';
  setActiveTab: (tab: 'keys' | 'usage' | 'documentation' | 'webhooks' | 'settings') => void;
}
...
export default function ApiLayout({ children }: ApiLayoutProps) {
  ...
  const [activeTab, setActiveTab] = useState<'keys' | 'usage' | 'documentation' | 'webhooks' | 'settings'>('keys');

...
export function ShareModal({ isOpen, onClose, document }: ShareModalProps) {
  ...
  const handleCreateShare = async () => {
    ...
    try {
      ...
      // const response = await fetch(`/api/workbench/documents/${document.id}/share`, {
      //   method: 'POST',
      ...
      // Mock response
      const mockShareUrl = `https://workbench.example.com/shared/${Math.random().toString(36).substr(2, 9)}`;

...
export function ParticleLeftPanel() {
  ...
  const filteredExperiments = experiments.filter(experiment => {
    ...
    if (searchQuery && !experiment.name.toLowerCase().includes(searchQuery.toLowerCase())) return false;
    return true;
  });
      ...
      <div className="p-4 border-b border-[var(--border)]">
        ...
        <div className="relative mb-4">
          <input
            ...
            className="w-full px-3 py-2 pl-10 border border-[var(--border)] rounded-lg bg-[var(--background)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <svg className="absolute left-3 top-2.5 w-4 h-4 text-[var(--muted-foreground)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
export default function CloseTheBuyerGapPage() {
          ...
          <div className="max-w-lg text-white">
            ...
            <div className="bg-black rounded-lg p-4 mb-8">
              ...
              <p className="text-gray-300 text-sm">
                of top performers include Economic Buyers in their sales process vs 8% of low performers<a href="#footnote-1" className="text-muted hover:text-white ml-1 text-xs">¹</a>
              </p>
            </div>
        ...
        <div className="w-1/2 bg-background flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            <form onSubmit={handleStep1Submit} className="space-y-6">
              <div>
                <h3 className="text-2xl font-bold text-foreground mb-6">Tell Us About Your Deal</h3>
              </div>
  ...
  return (
    <div className="fixed inset-0 flex">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-hover border-t border-border p-4 z-10">

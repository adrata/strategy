  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-12">
              ...
              <nav className="hidden md:flex space-x-6">
                <Link href="/what-is-the-buyer-gap" className="text-sm text-foreground font-semibold">
                  Buyer Gap
                </Link>
        ...
        <section className="py-32 bg-background">
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            <div className="text-left">
              ...
              <p className="text-xl text-muted mb-6 max-w-3xl">
          ...
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-foreground mb-2">11.7</div>
                  <p className="text-muted">
        ...
        <section className="py-20 bg-background">
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Scenario 1 */}
              <div className="bg-panel-background p-8 rounded-xl border border-border">
                ...
                <div className="bg-background p-4 rounded border-l-4 border-border">
                  <p className="font-semibold text-foreground text-sm">The Buyer Gap:</p>
                  <p className="text-muted text-sm">Activity with users ≠ Influence with decision makers</p>
                </div>
              </div>
              ...
              <div className="bg-panel-background p-8 rounded-xl border border-border">
                ...
                <div className="bg-background p-4 rounded border-l-4 border-border">
                  <p className="font-semibold text-foreground text-sm">The Buyer Gap:</p>
                  <p className="text-muted text-sm">Org chart coverage ≠ Decision maker coverage</p>
                </div>
              </div>
              ...
              <div className="bg-panel-background p-8 rounded-xl border border-border">
                ...
                <div className="bg-background p-4 rounded border-l-4 border-border">
                  <p className="font-semibold text-foreground text-sm">The Buyer Gap:</p>
                  <p className="text-muted text-sm">Stakeholder priorities ≠ Economic buyer priorities</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-background p-6 rounded-xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Buyer Behavior Study</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-muted">Buyers prefer to engage sellers late in process</span>
                    <span className="text-foreground font-bold">57%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted">Say conversations with sellers offer no value</span>
                    <span className="text-foreground font-bold">6x more than 2018</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted">Don't view sellers as valuable resource</span>
              ...
              <div className="bg-background p-6 rounded-xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Sales Performance Impact</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-muted">Organizations seeing longer sales cycles</span>
                    <span className="text-foreground font-bold">43%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted">More opportunities lost to no decision</span>
                    <span className="text-foreground font-bold">44%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted">Face challenges from more decision makers</span>
          ...
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-panel-background p-6 rounded-xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-4">CEO/CRO Pain</h3>
              ...
              <div className="bg-panel-background p-6 rounded-xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Sales Manager Pain</h3>
                <ul className="space-y-2 text-muted text-sm">
              ...
              <div className="bg-panel-background p-6 rounded-xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Sales Rep Pain</h3>
                <ul className="space-y-2 text-muted text-sm">
        ...
        <section className="py-20 bg-panel-background">
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            <div className="text-center">
              ...
              <div className="bg-background p-6 rounded-xl border border-border mb-8 max-w-3xl mx-auto">
                ...
                <p className="text-muted text-sm mt-2">- Salesforce State of Sales Report 2024</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/demo"
                  className="bg-background text-black border border-border px-8 py-3 rounded-lg font-medium hover:bg-panel-background transition-colors"
                >
                  See How It Works
                </Link>
              </div>
      ...
      <section className="py-12 bg-hover border-t border-border">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <h3 className="text-lg font-semibold text-foreground mb-6">References & Sources</h3>
          <div className="space-y-3 text-sm text-gray-700">
            ...
            <div id="footnote-6" className="border-l-4 border-black pl-4">
              ...
              <span className="text-muted">Methodology available upon request.</span>
            </div>
          </div>
        </div>
      </section>

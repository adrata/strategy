  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
          ...
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="bg-white p-12 rounded-2xl border border-gray-200 text-center">
              <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                  <div className="text-6xl font-bold text-gray-900 mb-4">THE BUYER GAP</div>
                ...
                <div className="grid md:grid-cols-3 gap-8 text-left">
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900">Immediate Effects</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900">Deal Consequences</h3>
                    <ul className="space-y-2 text-gray-600">
              ...
              <div className="bg-gray-50 p-8 rounded-2xl">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">of churn happens because wrong stakeholders were engaged during sales</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-2xl">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1 text-center">
                    ...
                    <p className="text-gray-600">months average for deals that stall vs 3.1 months for those that don't</p>
                  </div>
              ...
              <div className="bg-gray-50 p-8 rounded-2xl">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">of forecasted deals slip to next quarter due to incomplete stakeholder coverage</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-2xl">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1 text-center">
                    ...
                    <p className="text-gray-600">more likely to lose deals when you have incomplete buyer group intelligence</p>
                  </div>
                  <div className="order-1 md:order-2">
                    <h3 className="text-2xl font-semibold text-gray-900 mb-4">
          ...
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="bg-gray-50 p-12 rounded-2xl">
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6">Revenue Impact</h3>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      ...
                      <span className="font-semibold text-gray-900">+127%<a href="#footnote-8" className="text-black hover:underline ml-1 text-xs">⁸</a></span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      <span className="text-gray-700">Deal slippage rate</span>
                      <span className="font-semibold text-gray-900">+89%<a href="#footnote-9" className="text-black hover:underline ml-1 text-xs">⁹</a></span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                      <span className="text-gray-700">Customer churn increase</span>
                      <span className="font-semibold text-gray-900">+34%<a href="#footnote-7" className="text-black hover:underline ml-1 text-xs">⁷</a></span>
                    </div>
                  </div>
                </div>
                
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6">Operational Cost</h3>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      <span className="text-gray-700">Wasted sales effort per enterprise company</span>
                      <span className="font-semibold text-gray-900">$1.2M/year<a href="#footnote-11" className="text-black hover:underline ml-1 text-xs">¹¹</a></span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      <span className="text-gray-700">Increased CAC</span>
                      <span className="font-semibold text-gray-900">+156%<a href="#footnote-11" className="text-black hover:underline ml-1 text-xs">¹¹</a></span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      <span className="text-gray-700">Rep turnover cost</span>
                      <span className="font-semibold text-gray-900">$480K/year<a href="#footnote-11" className="text-black hover:underline ml-1 text-xs">¹¹</a></span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                      <span className="text-gray-700">Forecast inaccuracy</span>
                      <span className="font-semibold text-gray-900">±43%<a href="#footnote-9" className="text-black hover:underline ml-1 text-xs">⁹</a></span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 bg-gray-100 border-t border-gray-200">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Research Sources & References</h3>
          <div className="space-y-3 text-sm text-gray-700">
            ...
            <div id="footnote-11" className="border-l-4 border-black pl-4">
              ...
              <span className="text-gray-600">Detailed methodology and supporting data available upon request.</span>
            </div>
          </div>

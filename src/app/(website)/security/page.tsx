  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-12">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/security" className="text-sm text-foreground font-semibold">
                  Security
                </Link>
              </nav>
            </div>
        ...
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/demo"
                className="bg-background text-blue-600 px-8 py-3 rounded-lg text-lg font-medium border-2 border-blue-600 hover:bg-blue-50 transition-colors"
              >
                See Security Demo
              </Link>
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold text-foreground mb-4">Comprehensive Security Framework</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Data Encryption */}
            <div className="bg-panel-background p-8 rounded-xl">
              <Lock className="h-12 w-12 text-blue-600 mb-4" />
              <h3 className="text-xl font-semibold text-foreground mb-3">Data Encryption</h3>
            ...
            <div className="bg-panel-background p-8 rounded-xl">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Zero-Trust Access</h3>
              <p className="text-muted mb-4">
            ...
            <div className="bg-panel-background p-8 rounded-xl">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">24/7 Monitoring</h3>
              <p className="text-muted mb-4">
            ...
            <div className="bg-panel-background p-8 rounded-xl">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Audit Trails</h3>
              <p className="text-muted mb-4">
      ...
      <section className="py-20 bg-panel-background">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold text-foreground mb-4">Compliance & Certifications</h2>
            <p className="text-lg text-muted max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-background p-6 rounded-xl border border-border text-center">
              <CheckCircle className="h-8 w-8 text-green-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold text-foreground mb-2">GDPR</h3>
              <p className="text-sm text-muted">
            ...
            <div className="bg-background p-6 rounded-xl border border-border text-center">
              <CheckCircle className="h-8 w-8 text-green-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold text-foreground mb-2">CCPA</h3>
              <p className="text-sm text-muted">
            ...
            <div className="bg-background p-6 rounded-xl border border-border text-center">
              <CheckCircle className="h-8 w-8 text-green-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold text-foreground mb-2">HIPAA Ready</h3>
              <p className="text-sm text-muted">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-semibold text-foreground mb-6">Security Best Practices</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Regular Security Assessments</h3>
                ...
                <div className="flex items-start space-x-4">
                  <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Employee Security Training</h3>
                    <p className="text-muted">
                ...
                <div className="flex items-start space-x-4">
                  <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Incident Response Plan</h3>
                    <p className="text-muted">
            ...
            <div className="bg-panel-background p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-foreground mb-6">Security Metrics</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-muted">Security Incidents (2024)</span>
                  <span className="text-2xl font-bold text-green-600">0</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted">Data Breaches</span>
                  <span className="text-2xl font-bold text-green-600">0</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted">Uptime SLA</span>
      ...
      <section className="py-20 bg-blue-50">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-foreground mb-4">Security Contact & Resources</h2>
            <p className="text-lg text-muted max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Report a Vulnerability</h3>
              <p className="text-muted mb-4">
      ...
      <footer className="bg-foreground text-white py-16">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center text-muted">

          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-12">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/buyer-gap-cost" className="text-sm text-foreground font-semibold">
                  Cost Calculator
                </Link>
      ...
      <main className="flex-1">
          ...
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            <div className="grid lg:grid-cols-2 gap-12">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent"
                        placeholder="57,500"
                      />
                    </div>
                  </div>
              ...
              <div className="bg-background p-8 rounded-xl border border-border">
                ...
                {/* Main Result */}
                <div className="bg-panel-background p-6 rounded-xl mb-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-foreground mb-2">
                      -{formatCurrency(calculatedCost)}
                    </div>
                    <p className="text-muted">Annual revenue lost to Buyer Gap</p>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm text-muted mb-6">
                  ...
                  <div className="font-mono bg-panel-background p-3 rounded">
                ...
                {/* Email Results */}
                <form onSubmit={handleEmailSubmit} className="border-t border-border pt-6">
                  <h3 className="font-medium text-foreground mb-3">Download PDF Report</h3>
                  ...
                  <div className="flex space-x-3">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent text-sm"
                    />
                    <button
                      type="submit"
        ...
        <section className="py-20 bg-background">
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="bg-panel-background p-8 rounded-xl mb-12">
              <div className="text-center mb-8">
                <h3 className="text-xl font-semibold text-foreground mb-4">The Formula</h3>
                <div className="text-lg font-mono bg-background p-4 rounded-lg border border-border">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div className="text-center">
                  <div className="bg-background p-4 rounded-lg border border-border">
                    <h4 className="font-semibold text-foreground mb-2">ADS</h4>
                    <p className="text-sm text-muted">Average Deal Size</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-background p-4 rounded-lg border border-border">
                    <h4 className="font-semibold text-foreground mb-2">TAO</h4>
                    <p className="text-sm text-muted">Total Annual Opportunities</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-background p-4 rounded-lg border border-border">
                    <h4 className="font-semibold text-foreground mb-2">Visibility Rate</h4>
                    <p className="text-sm text-muted">% of stakeholders you identify</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-background p-4 rounded-lg border border-border">
                    <h4 className="font-semibold text-foreground mb-2">30%</h4>
                    <p className="text-sm text-muted">Fixed risk multiplier</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-panel-background">
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Mid Market Example */}
              <div className="bg-background p-8 rounded-xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Mid Market</h3>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted">Annual Opportunities:</span>
                    <span className="font-medium">100</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted">Visibility Rate:</span>
        ...
        {/* References & Sources */}
        <section className="py-16 bg-panel-background">
          <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">

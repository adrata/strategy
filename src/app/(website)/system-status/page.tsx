  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="divide-y divide-gray-200">
              <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <div>
                    <h3 className="font-medium text-foreground">Buyer Group Intelligence API</h3>
                    <p className="text-sm text-muted">Core AI analysis engine</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-green-600">Operational</div>
                  <div className="text-xs text-muted">99.9% uptime</div>
                </div>
              </div>
              ...
              <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <div>
                    <h3 className="font-medium text-foreground">Stakeholder Mapping</h3>
                    <p className="text-sm text-muted">Real-time relationship analysis</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-green-600">Operational</div>
                  <div className="text-xs text-muted">99.8% uptime</div>
                </div>
              </div>
              ...
              <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <div>
                    <h3 className="font-medium text-foreground">Data Enrichment</h3>
                    <p className="text-sm text-muted">Contact and company intelligence</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-green-600">Operational</div>
              ...
              <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <div>
                    <h3 className="font-medium text-foreground">CRM Integrations</h3>
                    <p className="text-sm text-muted">Salesforce, HubSpot, and other connectors</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-green-600">Operational</div>
                  <div className="text-xs text-muted">99.7% uptime</div>
                </div>
              </div>
              ...
              <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <div>
                    <h3 className="font-medium text-foreground">Web Application</h3>
                    <p className="text-sm text-muted">Main platform interface</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-green-600">Operational</div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-8xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-foreground mb-8">Performance Metrics</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-panel-background p-6 rounded-xl border border-border">
              <div className="text-3xl font-bold text-foreground mb-2">99.9%</div>
              <div className="text-sm font-medium text-muted mb-1">Overall Uptime</div>
              <div className="text-xs text-muted">Last 30 days</div>
            </div>
            <div className="bg-panel-background p-6 rounded-xl border border-border">
              <div className="text-3xl font-bold text-foreground mb-2">120ms</div>
              <div className="text-sm font-medium text-muted mb-1">Average Response Time</div>
              <div className="text-xs text-muted">API endpoints</div>
            </div>
            <div className="bg-panel-background p-6 rounded-xl border border-border">
              <div className="text-3xl font-bold text-foreground mb-2">0</div>
              <div className="text-sm font-medium text-muted mb-1">Active Incidents</div>
      ...
      <section className="py-20 bg-panel-background">
        <div className="max-w-8xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-foreground mb-8">Recent Incidents</h2>
          <div className="bg-background rounded-xl border border-border p-8">
            <div className="text-center py-12">
              ...
              <p className="text-muted">All systems have been running smoothly for the past 30 days.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          {newsletterSubmitted ? (
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <input
                ...
                required
                className="flex-1 px-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
              />
              <button 
                type="submit"

...
export default function ModernLanding() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <main className="relative z-10 px-4 py-20 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/demo" className="border border-gray-300 text-gray-700 px-8 py-3 rounded-md text-lg font-semibold hover:bg-gray-50 transition-colors">
              Watch Demo
            </Link>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 px-4 py-12 bg-gray-900/80">
        <div className="max-w-7xl mx-auto">

  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-panel-background">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-foreground mb-4">Why Adrata?</h2>
            <p className="text-lg text-muted">Work on technology that matters with people who care</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Groundbreaking Technology</h3>
            ...
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Research-Driven</h3>
              <p className="text-muted">
            ...
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Massive Impact</h3>
              <p className="text-muted">
            ...
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Learning Culture</h3>
              <p className="text-muted">
            ...
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Global Remote</h3>
              <p className="text-muted">
            ...
            <div className="bg-background p-8 rounded-xl border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Equity & Benefits</h3>
              <p className="text-muted">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-[90rem] mx-auto px-8 sm:px-12 lg:px-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-foreground mb-4">What We're Looking For</h2>
            <p className="text-lg text-muted">The kind of people who thrive at Adrata</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-xl font-semibold text-foreground mb-6">Engineering</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-foreground mb-6">Research & Product</h3>
              <ul className="space-y-3 text-muted">
            ...
            <div>
              <h3 className="text-xl font-semibold text-foreground mb-6">Business</h3>
              <ul className="space-y-3 text-muted">
            ...
            <div>
              <h3 className="text-xl font-semibold text-foreground mb-6">Operations</h3>
              <ul className="space-y-3 text-muted">

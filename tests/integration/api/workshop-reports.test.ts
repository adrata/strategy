...
describe('Atrium Reports API Integration Tests', () => {
  ...
  describe('GET /api/atrium/reports', () => {
    it('should list all reports', async () => {
      ...
      const atriumDocs = reports.map(report => createTestWorkshopDocument('PAPER', {
        metadata: {
    ...
    it('should filter reports by type', async () => {
      ...
      const atriumDocs = executiveReports.map(report => createTestWorkshopDocument('PAPER', {
        metadata: {
          reportType: report.type,
          recordType: report.recordType,
          recordId: report.recordId,
    ...
    it('should filter reports by record type', async () => {
      ...
      const atriumDocs = peopleReports.map(report => createTestWorkshopDocument('PAPER', {
        metadata: {
          reportType: report.type,
          recordType: report.recordType,
          recordId: report.recordId,

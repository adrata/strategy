...
async function simpleEmailLinkingCheck() {
  try {
    ...
    // 2. EMAIL LINKING TO EXISTING ENTITIES
    ...
    const overallCoverage = ((totalLinks / (totalEmails * 5)) * 100).toFixed(1); // 5 entity types

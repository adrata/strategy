...
// Sample data from what we can see (first 8 contacts)
...
// Run the import with sample data
importAltaContacts(sampleContacts)
  .then(stats => {
    console.log('\n✅ Import completed successfully!');
    console.log('\n📝 NOTE: This was a test run with 8 sample contacts.');
    console.log('   The full dataset appears to have file encoding issues.');
    console.log('   Please check the alta-contacts.json file and try again.');
    process.exit(0);
  })
  .catch(error => {
    console.error('\n❌ Import failed:', error);

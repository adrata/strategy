...
async function sendRossEmail() {
  console.log('📧 [SEND EMAIL] Sending invitation email to ross@adrata.com via Resend\n');
  ...
  try {
    ...
    if (!process.env.RESEND_API_KEY) {
      ...
      console.log(`\n📧 [MANUAL SEND] You can send this link to Ross manually:`);
      console.log(`Subject: Invitation to join ${workspace.name} workspace on Adrata`);
      console.log(`To: ross@adrata.com`);

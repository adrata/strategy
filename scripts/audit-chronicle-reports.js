...
async function auditChronicleReports() {
  try {
    console.log('🔍 Chronicle Reports Audit');
    console.log('========================\n');
    ...
    console.log('📊 ChronicleReport Table:');
    console.log('-------------------------');
    ...
    console.log('📅 This Week Analysis:');
    console.log('----------------------');
    ...
    console.log('\n🎯 Bi-weekly/Presentation Report Check:');
    ...
    console.log(`✅ Atrium documents: ${atriumChronicleDocs.length} documents`);
    console.log(`📅 This week reports: ${thisWeekChronicleReports.length} Chronicle, ${thisWeekAtriumDocs.length} Atrium`);
    console.log(`📊 Weekly reports: ${weeklyChronicleReports.length} Chronicle, ${weeklyAtriumDocs.length} Atrium`);
    console.log(`🎯 Presentation reports: ${presentationChronicleReports.length} Chronicle, ${presentationAtriumDocs.length} Atrium`);

    if (thisWeekChronicleReports.length === 0 && thisWeekAtriumDocs.length === 0) {
      console.log('\n⚠️  WARNING: No reports found for this week!');
    }

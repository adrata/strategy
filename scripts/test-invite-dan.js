...
async function testInviteRoss() {
  ...
  try {
    ...
    // 7. Test email sending (optional - might fail in development)
    console.log('\n7️⃣ [EMAIL TEST] Testing email sending...');
    try {
      ...
      if (emailResult.success) {
        ...
        console.log('   This is normal in development - use the link above to test');
      }
    } catch (emailError) {

...
/**
 * TOP Database Buyer Group Audit Script
...
async function runBuyerGroupAudit() {
  ...
  try {
    ...
    // 8. COMPANY BUYER GROUP ANALYSIS
    ...
    // 9. DETAILED BUYER GROUP BREAKDOWN
    ...
    const buyerGroupDetails = await prisma.buyer_groups.findMany({
      ...
      take: 10 // Show first 10 for sample
    });

...
/**
 * 🔍 RESEARCH MISSING WEBSITES WITH PERPLEXITY
 * 
 * Uses Perplexity to research companies without websites and find their official websites
 */

const { PrismaClient } = require('@prisma/client');

class ResearchMissingWebsites {
  constructor() {
  ...
  async execute() {
    console.log('🔍 RESEARCHING MISSING WEBSITES WITH PERPLEXITY');
    console.log('==============================================\n');
...
if (require.main === module) {
  const researcher = new ResearchMissingWebsites();
  researcher.execute().catch(console.error);
}

module.exports = ResearchMissingWebsites;

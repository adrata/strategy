...
/**
 * 🚀 MIGRATE TOP ENGINEERING PLUS
 * 
 * Migrates TOP Engineering Plus workspace data from old SBI database
 */
...
async function migrateTopEngineeringPlus() {
  try {
    console.log('🚀 Migrating TOP Engineering Plus workspace...\n');

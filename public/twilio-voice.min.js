                      ...
                      if (
                        ...
                        outputDevices
                          ...
                          .catch(function (reason) {
                            _this._log.warn(
                              "Unable to set audio output devices. ".concat(
                                reason,
                              ),
                            );
                          });
                ...
                navigator.permissions
                  ...
                  .catch(function (reason) {
                    return _this._log.warn(
                      "Warning: unable to listen for microphone permission changes. ".concat(
                        reason,
                      ),
                    );
                  });
            ...
            AudioHelper.prototype._initializeEnumeration = function () {
              ...
              this._updateAvailableDevices().then(function () {
                ...
                Promise.all([
                  ...
                  _this._log.warn(
                    "Warning: Unable to set audio output devices. ".concat(
                      reason,
                    ),
                  );
                });
                          ...
                          case 1:
                            ...
                            if (!device) {
                              return [
                                ...
                                Promise.reject(
                                  new errors_1.InvalidArgumentError(
                                    "Device not found: ".concat(deviceId),
                                  ),
                                ),
                              ];
                            }
              ...
              if (!options.label) {
                if (options.deviceId === "default") {
                  ...
                  options.label = "Unknown "
                    .concat(kindAliases[options.kind], " Device ")
                    .concat(index);
                }
              }
          ...
          var Call = (function (_super) {
            ...
            function Call(config, options) {
              ...
              _this._onMessageReceived = function (payload) {
                ...
                if (_this.parameters.CallSid !== callsid) {
                  _this._log.warn(
                    "Received a message from a different callsid: ".concat(
                      callsid,
                    ),
                  );
                  return;
              ...
              _this._onMessageSent = function (voiceEventSid) {
                if (!_this._messages.has(voiceEventSid)) {
                  _this._log.warn(
                    "Received a messageSent with a voiceEventSid that doesn't exists: ".concat(
                      voiceEventSid,
                    ),
                  );
                  return;
              ...
              _this._onSignalingError = function (payload) {
                ...
                if (_this.parameters.CallSid !== callsid) {
                  _this._log.warn(
                    "Received an error from a different callsid: ".concat(
                      callsid,
                    ),
                  );
                  return;
            ...
            Call.prototype.accept = function (options) {
              ...
              if (this._status !== Call.State.Pending) {
                this._log.debug(
                  ".accept noop. status is '".concat(this._status, "'"),
                );
                return;
              }
              options = options || {};
              ...
              var connect = function () {
                ...
                if (_this._direction === Call.CallDirection.Incoming) {
                  ...
                  var params = Array.from(_this.customParameters.entries())
                    .map(function (pair) {
                      return ""
                        .concat(encodeURIComponent(pair[0]), "=")
                        .concat(encodeURIComponent(pair[1]));
                    })
                    .join("&");
                  _this._pstream.on("answer", _this._onAnswer);
            ...
            Call.prototype.ignore = function () {
              ...
              if (this._status !== Call.State.Pending) {
                this._log.debug(
                  ".ignore noop. status is '".concat(this._status, "'"),
                );
                return;
              }
            ...
            Call.prototype.reject = function () {
              ...
              if (this._status !== Call.State.Pending) {
                this._log.debug(
                  ".reject noop. status is '".concat(this._status, "'"),
                );
                return;
              }
      ...
      10: [
        function (require, module, exports) {
          ...
          var COWBELL_AUDIO_URL = ""
            .concat(SOUNDS_BASE_URL, "/cowbell.mp3?cache=")
            .concat(RELEASE_VERSION);
          ...
          var Device = (function (_super) {
            ...
            function Device(token, options) {
              ...
              _this._onSignalingConnected = function (payload) {
                ...
                (_a = _this._publisher) === null || _a === void 0
                  ? void 0
                  : _a.setHost(
                      (0, regions_1.createEventGatewayURI)(payload.home),
                    );
                if (payload.token) {
                  ...
                  switch (_a.label) {
                    case 0:
                      ...
                      if (this.state !== Device.State.Unregistered) {
                        throw new errors_1.InvalidStateError(
                          'Attempt to register when device is in state "'.concat(
                            this.state,
                            '". ',
                          ) +
                  ...
                  switch (_a.label) {
                    case 0:
                      ...
                      if (this.state !== Device.State.Registered) {
                        throw new errors_1.InvalidStateError(
                          'Attempt to unregister when device is in state "'.concat(
                            this.state,
                            '". ',
            ...
            Device.prototype.updateOptions = function (options) {
              ...
              var newChunderURIs = (this._chunderURIs = (
                this._getChunderws() ||
                (0, regions_1.getChunderURIs)(this._options.edge)
              ...
              for (
                ...
                var defaultUrl =
                  ""
                    .concat(C.SOUNDS_BASE_URL, "/")
                    .concat(soundDef.filename, ".")
                      ...
                      case 3:
                        ...
                        this._publisher.info(
                          ...
                          "init",
                          {
                            MediaStream: !!this._options.MediaStream,
                            RTCPeerConnection:
                              !!this._options.RTCPeerConnection,
            ...
            Device.prototype._setupStream = function () {
              ...
              return (this._streamConnectedPromise = (0,
              util_1.promisifyEvents)(this._stream, "connected", "close").then(
                function () {
          ...
          function getErrorByCode(code) {
            ...
            if (!error) {
              throw new InvalidArgumentError(
                "Error code ".concat(code, " not found"),
              );
            }
            return error;
          }
          ...
          EventPublisher.prototype._post = function _post(
            ...
            return new Promise(function (resolve, reject) {
              ...
              _this._log.error(
                "Unable to post "
                  .concat(group, " ")
                  .concat(name, " event to Insights. Received error: ")
                  .concat(e),
              );
            });
          };
        ...
        function (require, module, exports) {
          ...
          function createRTCCodecStats(report) {
            return {
              ...
              mimeType: ""
                .concat(report.stat("mediaType"), "/")
                .concat(report.stat("googCodecName")),
        ...
        function (require, module, exports) {
          ...
          PeerConnection.prototype._setupChannel = function () {
            ...
            pc.onicecandidate = function (event) {
              ...
              _this._log.info(
                "ICE Candidate: ".concat(JSON.stringify(candidate)),
              );
            };
          ...
          PeerConnection.prototype._setupRTCDtlsTransportListener =
            function () {
              ...
              var handler = function () {
                _this._log.info(
                  'dtlsTransportState is "'.concat(dtlsTransport.state, '"'),
                );
          ...
          PeerConnection.prototype.iceRestart = function () {
            ...
            this.version
                ...
                _this._onAnswerOrRinging = function (payload) {
                  ...
                  if (
                    ...
                    var message =
                      ...
                      "hasSdp:"
                        .concat(!!payload.sdp, ", signalingState:")
                        .concat(_this.version.pc.signalingState);
                  ...
                  if (_this.status !== "closed") {
                    _this.version.processAnswer(
                      ...
                      function (err) {
                        ...
                        _this._log.error(
                          "Failed to process answer during ICE Restart. Error: ".concat(
                            message,
                          ),
                        );
                      },
              ...
              .catch(function (err) {
                var message = err && err.message ? err.message : err;
                _this._log.error(
                  "Failed to createOffer during ICE Restart. Error: ".concat(
                    message,
                  ),
                );
            ...
            StatsMonitor.prototype._createSample = function (
              ...
              return {
                audioInputLevel: Math.round(
                  (0, util_1.average)(audioInputLevelValues),
                ),
      ...
      38: [
        function (require, module, exports) {
          ...
          (function (WSTransportState) {
            ...
            WSTransportState ||
              (exports.WSTransportState = WSTransportState = {}),
          );
          var WSTransport = (function (_super) {
            ...
            function WSTransport(uris, options) {
              ...
              _this._onSocketError = function (err) {
                _this._log.error(
                  "WebSocket received error: ".concat(err.message),
                );
                _this.emit("error", {
                  code: 31e3,
            ...
            WSTransport.prototype._connect = function (uri, retryCount) {
              ...
              this._log.info(
                typeof retryCount === "number"
                  ? "Attempting to reconnect (retry #".concat(
                      retryCount,
                      ")...",
                    )
